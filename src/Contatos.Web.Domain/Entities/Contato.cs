...
public class Contato : BaseEntity
{
    ...
    [MaxLength(9, ErrorMessage = "Limite máximo atingido! Máximo de 50 caracteres")]
    [Range(0, int.MaxValue, ErrorMessage ="Campo telefone aceita somente números")]
    public string? Telefone { get; set; }

    [Required(ErrorMessage = "Campo DDD é obrigatório!")]
    [Range(10, 99, ErrorMessage = "Campo DDD aceita somente números!")]
